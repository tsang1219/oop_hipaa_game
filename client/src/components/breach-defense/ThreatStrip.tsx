...
export function ThreatStrip({ threats }: ThreatStripProps) {
  ...
  return (
    <div
      className="flex items-center gap-3 px-4 py-1.5 bg-[#2a2a3e] border-2 border-[#FF6B9D] rounded w-[640px] flex-wrap"
      style={{ fontFamily: '"Press Start 2P", monospace' }}
    >
      <span className="text-[7px] text-gray-500 mr-1">INCOMING:</span>
      {threats.map((t, i) => {
